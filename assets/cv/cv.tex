...
\textbf{Climate migration projections across disciplines: a model inter-comparison for the US} \\
\textit{
    (with
...
Draft available \href{https://tombearpark.com/assets/2026_MIGICP.pdf}{here}.
...
\textbf{The global mortality consequences of rainfall} \\
\textit{
    (with
    \href{https://sites.google.com/site/ashwinrode/home}{Ashwin Rode} and
    \href{https://www.udel.edu/academics/colleges/ceoe/departments/smsp/faculty/james-rising/}{James Rising})
}
...
{\sl 2026:} Richard Doll Seminar (University of Oxford, UK), Energy and Environment Group Talk Series (University of Cambridge, UK), CMIP Seminar (World Climate Research Programme).\\
\\
